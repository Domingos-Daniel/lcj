...
import { Facebook, Github, LucideFacebook } from "lucide-react"
            ...
            <CardContent>
              <div className="grid gap-6">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <Button variant="outline">
                    <LucideFacebook className="mr-2 h-4 w-4" />
                    Facebook
                  </Button>
                </div>
                ...
                <div className="grid gap-2">
                  ...
                  <Input id="email" type="email" placeholder="seuemail@example.com" />
                </div>
                <div className="grid gap-2">
