...
import { Loader2 } from "lucide-react"; // Removi o Facebook
          ...
          <Card className="border-0 shadow-md">
            ...
            <CardContent>
              ...
              <div className="grid gap-6">
                ...
                <Button 
                  className="w-full bg-white text-gray-700 border border-gray-300 hover:bg-gray-50 focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 flex items-center justify-center" 
